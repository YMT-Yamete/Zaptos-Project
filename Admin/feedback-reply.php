            ...
            <div class="container">
                <form action="feedback-reply.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="inputSubject" placeholder="Enter subject here" required>
                    </div>
                    <div class="mb-3">
                        <label for="email text" class="form-label">Email Text</label><br>
                        <textarea style="width: 100%; border-color: #ced4da;" name="inputReply" rows="5" required></textarea>
                    </div>
