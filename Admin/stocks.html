...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                <h2 class="pageHeader">Stocks</h2>
                <table style="margin-left: auto;">
                    <tr>
                        <td>
                            <a href="add-product.html"><button type="button" class="btn"
                                    style="background-color: #005C67; color: white;">Add New Product +</button></a>
                        </td>
                    </tr>
                </table>
                <br>
                <table id="tableID" class="table table-bordered table-striped table-responsive-stack">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>1000 MMK</td>
                            <td>100</td>
                            <td><a href="edit-product.html">Edit Product</a></td>
                        </tr>
                        <tr>
                            <td>
                                <img src="../Imgs/Assets/car-cover.jpg" alt="" width="200px">
