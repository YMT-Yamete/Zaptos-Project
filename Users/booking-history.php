...
<body>
  ...
  <div class="container p-3">
    ...
    <div class="btn-group-center" role="group" aria-label="Basic example" style="text-align: center;">
      <a href="booking-history.php">
        <button type="button" class="btn btn-secondary" style="background-color: #008a9a;">Booking</button>
      </a>
      <a href="shopping-history.php">
        <button type="button" class="btn btn-secondary" style="background-color: #005C67;">Shopping</button>
      </a>
    </div><br>
    <div class="card">
      <div class="row">
        <div class="col-md-12 cart p-5">
          <?php
          if ($count <= 0) {
            echo "<h3 style='text-align: center;'>No Bookings Yet</h3>";
          }
          while ($row = $query->fetch_assoc()) {
            ...
            '<div class="row border-top border-bottom">
              <div class="row main align-items-center">
                <div class="col-2 p-3">
                  <img class="img-fluid" src="../Imgs/Assets/car-wash.jpg" width="300px" height="500px">
                </div>
                <div class="col">
                  <div class="row text-muted">' . $row["BookingID"] . '</div>
                </div>
                <div class="col">' . $row["Date"] . '</div>
                <div class="col">' . $row["BookingStatus"] . '</div>
                <div class="col">' . $row["Cost"] . '<a href="booking-receipt.php?BookingID=' . $row["BookingID"] . '"><span class="close">&rarr;</span></a></div>
              </div>
            </div>';
          }
          ?>
